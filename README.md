...
База данных размещена на бесплатном тарифе Supabase (сервер в Вашингтоне, США). При первом обращении к базе данных возможна задержка до 10-15 секунд при загрузке меню, бронирований и других данных. Это связано с тем, что бесплатный тариф использует общие ресурсы и база данных "засыпает" при отсутствии запросов.
